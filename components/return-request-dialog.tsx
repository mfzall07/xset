...
interface ReturnRequestDialogProps {
  ...
  onReturnRequested: (returnRequest: any) => void
}
...
export function ReturnRequestDialog({ open, onOpenChange, onReturnRequested }: ReturnRequestDialogProps) {
  ...
  const handleConditionChange = (value: string) => {
    setFormData((prev) => ({
      ...prev,
      condition: value as "good" | "damaged" | "missing-parts" | "lost",
    }))
  }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            <DialogTitle>Request Asset Return</DialogTitle>
            <DialogDescription>Fill out the form to process an asset return.</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={handleChange}
                rows={3}
                placeholder={formData.condition !== "good" ? "Please describe the condition or issue" : ""}
              />
            </div>
          </div>
          <DialogFooter>
